...
There are three map types in Datawrapper. I'm trying to explain in short, how you can use DatawRappr to create a map programmatically in each one of them.
...
# TBC: Including tooltips

This tutorial will be put out soon.
